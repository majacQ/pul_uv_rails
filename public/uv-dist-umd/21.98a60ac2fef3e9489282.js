...
/* harmony import */ var _index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index-9a55a5eb.js */ "./node_modules/@universalviewer/aleph/dist/esm-es5/index-9a55a5eb.js");
...
var ViewController = /** @class */ (function () {
    ...
    ViewController.prototype._destroy = function () {
        Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.state !== VIEW_STATE_DESTROYED, 'view state must be ATTACHED');
...
var Nav = /** @class */ (function () {
    ...
    class_1.prototype.componentDidUnload = function () {
        for (var _i = 0, _a = this.views; _i < _a.length; _i++) {
            var view = _a[_i];
            Object(_index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["L"]);
            view._destroy();
        }
        if (this.gesture) {
    ...
    class_1.prototype.prepareTI = function (ti) {
        ...
        if (ti.removeView !== undefined) {
            Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(ti.removeStart !== undefined, 'removeView needs removeStart');
            Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(ti.removeCount !== undefined, 'removeView needs removeCount');
        ...
        Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(insertViews.length > 0, 'length can not be zero');
    ...
    class_1.prototype.postViewInit = function (enteringView, leavingView, ti) {
        Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(leavingView || enteringView, 'Both leavingView and enteringView are null');
        Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(ti.resolve, 'resolve must be valid');
        Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(ti.reject, 'reject must be valid');
        var opts = ti.opts;
        var insertViews = ti.insertViews;
        var removeStart = ti.removeStart;
        ...
        if (removeStart !== undefined && removeCount !== undefined) {
            Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(removeStart >= 0, 'removeStart can not be negative');
            Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(removeCount >= 0, 'removeCount can not be negative');
            destroyQueue = [];
        ...
        Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(finalBalance >= 0, 'final balance can not be negative');
        if (finalBalance === 0) {
        ...
        if (destroyQueue && destroyQueue.length > 0) {
            for (var _a = 0, destroyQueue_1 = destroyQueue; _a < destroyQueue_1.length; _a++) {
                ...
                Object(_index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["a"]);
                Object(_index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["b"]);
                Object(_index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["L"]);
            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Object(_index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["t"])(animationOpts)];
                    case 1:
    ...
    class_1.prototype.insertViewAt = function (view, index) {
        ...
        if (existingIndex > -1) {
            ...
            Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(view.nav === this, 'view is not part of the nav');
            views.splice(index, 0, views.splice(existingIndex, 1)[0]);
        }
        else {
            Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(!view.nav, 'nav is used');
    ...
    class_1.prototype.removeView = function (view) {
        Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(view.state === VIEW_STATE_ATTACHED || view.state === VIEW_STATE_DESTROYED, 'view state should be loaded or destroyed');
        var views = this.views;
        var index = views.indexOf(view);
        Object(_helpers_c01667ee_js__WEBPACK_IMPORTED_MODULE_1__["e"])(index > -1, 'view must be part of the stack');
        if (index >= 0) {
    ...
    class_1.prototype.cleanup = function (activeView) {
        ...
        for (var i = views.length - 1; i >= 0; i--) {
            ...
            if (i > activeViewIndex) {
                ...
                // let's unload it
                Object(_index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["l"])(element, _index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["L"]);
                this.destroyView(view);
            }
            else if (i < activeViewIndex) {
                // this view comes before the active view
                // and it is not a portal then ensure it is hidden
                Object(_index_9a55a5eb_js__WEBPACK_IMPORTED_MODULE_4__["s"])(element, true);
            }
        }
    };
...
//# sourceMappingURL=21.98a60ac2fef3e9489282.js.map