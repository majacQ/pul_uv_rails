(window["webpackJsonpUV"] = window["webpackJsonpUV"] || []).push([["uv-aleph-extension~uv-default-extension~uv-ebook-extension~uv-mediaelement-extension~uv-model-viewer~d066739a"],{

/***/ "./package.json":
/*!**********************!*\
  !*** ./package.json ***!
  \**********************/
/*! exports provided: name, version, description, engines, files, main, scripts, repository, keywords, author, license, bugs, homepage, devDependencies, dependencies, collective, jest, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"universalviewer\",\"version\":\"4.0.0-pre.49\",\"description\":\"The Universal Viewer is a community-developed open source project on a mission to help you share your content with the world.\",\"engines\":{\"node\":\">=8.9.1\",\"npm\":\">=3.10.8\"},\"files\":[\"dist/\"],\"main\":\"dist/uv-dist-umd/UV.js\",\"scripts\":{\"build:dist\":\"npm run lint:all && grunt build --dist\",\"build\":\"grunt build\",\"e2eserve\":\"npx serve www -p 4444\",\"lint:all\":\"prettier --write \\\"./src/**/*.{js,jsx,json,css,ts,tsx}\\\" \\\"!./src/lib/* \\\"\",\"postinstall\":\"opencollective postinstall\",\"start\":\"npx serve www\",\"test\":\"jest\",\"prepublishOnly\":\"npm run build:dist\"},\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/universalviewer/universalviewer.git\"},\"keywords\":[\"IIIF\",\"Viewer\",\"Image\",\"AV\",\"PDF\",\"ePub\",\"3D\"],\"author\":\"@edsilv\",\"license\":\"MIT\",\"bugs\":{\"url\":\"https://github.com/universalviewer/universalviewer/issues\"},\"homepage\":\"https://github.com/universalviewer/universalviewer\",\"devDependencies\":{\"@types/jest\":\"22.2.2\",\"@types/puppeteer\":\"1.9.0\",\"async\":\"0.9.0\",\"chai\":\"4.1.2\",\"chalk\":\"0.5.1\",\"glob\":\"7.1.3\",\"glob-array\":\"1.0.0\",\"grunt\":\"1.0.3\",\"grunt-cli\":\"1.3.1\",\"grunt-contrib-clean\":\"0.4.0\",\"grunt-contrib-concat\":\"1.0.1\",\"grunt-contrib-copy\":\"0.4.1\",\"grunt-sync\":\"0.8.0\",\"grunt-text-replace\":\"0.3.7\",\"grunt-webpack\":\"3.1.3\",\"hooker\":\"0.2.3\",\"http-server\":\"0.11.1\",\"jest\":\"23.6.0\",\"jest-puppeteer\":\"3.5.0\",\"less\":\"2.4.0\",\"lodash\":\"4.17.11\",\"ncp\":\"2.0.0\",\"prettier\":\"^1.19.1\",\"prettier-check\":\"^2.0.0\",\"puppeteer\":\"1.9.0\",\"serve\":\"10.0.2\",\"ts-jest\":\"22.4.2\",\"ts-loader\":\"6.2.1\",\"tslint-config-prettier\":\"^1.18.0\",\"typescript\":\"3.6.3\",\"typescript-tslint-plugin\":\"^0.5.5\",\"webpack\":\"4.41.0\",\"webpack-bundle-analyzer\":\"3.5.2\",\"webpack-cli\":\"3.3.9\"},\"dependencies\":{\"@edsilv/http-status-codes\":\"1.0.3\",\"@edsilv/jquery-plugins\":\"1.0.8\",\"@edsilv/key-codes\":\"1.0.0\",\"@edsilv/utils\":\"1.0.2\",\"@google/model-viewer\":\"1.2.1\",\"@iiif/base-component\":\"2.0.1\",\"@iiif/iiif-av-component\":\"1.0.1\",\"@iiif/iiif-gallery-component\":\"1.1.19\",\"@iiif/iiif-metadata-component\":\"^1.1.19\",\"@iiif/iiif-tree-component\":\"^2.0.3\",\"@iiif/manifold\":\"2.0.2\",\"@iiif/vocabulary\":\"1.0.19\",\"@types/modernizr\":\"3.2.29\",\"@types/node\":\"8.10.52\",\"@universalviewer/aleph\":\"0.0.15\",\"@universalviewer/uv-cy-gb-theme\":\"1.1.2\",\"@universalviewer/uv-ebook-components\":\"1.0.2\",\"@universalviewer/uv-en-gb-theme\":\"MorphoSource/uv-en-gb-theme\",\"@webcomponents/webcomponentsjs\":\"^2.4.3\",\"core-js\":\"2.4.1\",\"dashjs\":\"2.6.7\",\"hls.js\":\"0.9.1\",\"jquery\":\"3.5.0\",\"jquery-binarytransport\":\"1.0.0\",\"jquery-ui-dist\":\"1.12.1\",\"jquery-ui-touch-punch\":\"0.2.3\",\"jsviews\":\"0.9.83\",\"manifesto.js\":\"4.0.1\",\"mediaelement\":\"4.2.15\",\"opencollective\":\"1.0.3\",\"openseadragon\":\"2.4.2\",\"pdfjs-dist\":\"2.0.161\",\"pdfobject\":\"2.1.1\",\"waveform-data\":\"2.0.2\",\"whatwg-fetch\":\"^3.0.0\",\"xss\":\"1.0.3\"},\"collective\":{\"type\":\"opencollective\",\"url\":\"https://opencollective.com/universalviewer\",\"logo\":\"https://opencollective.com/opencollective/logo.txt\"},\"jest\":{\"globals\":{\"ts-jest\":{\"enableTsDiagnostics\":true}},\"preset\":\"jest-puppeteer\",\"transform\":{\"^.+\\\\.tsx?$\":\"ts-jest\"},\"testPathIgnorePatterns\":[\"/node_modules/\"],\"testRegex\":\"(/__tests__/.*|(\\\\.|/)(test|spec))\\\\.(jsx?|tsx?)$\",\"moduleFileExtensions\":[\"ts\",\"tsx\",\"js\",\"jsx\",\"json\",\"node\"]}}");
...
/*!**********************!*\
  !*** ./src/Utils.ts ***!
  \**********************/
/*! exports provided: sanitize, isValidUrl, debounce, propertiesChanged, propertyChanged */
...
var MoreInfoRightPanel = /** @class */ (function (_super) {
    ...
    MoreInfoRightPanel.prototype.create = function () {
        ...
        _super.prototype.create.call(this);
        this.component.subscribe(_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].CANVAS_INDEX_CHANGE, function () {
            _this.databind();
        });
        this.component.subscribe(_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].RANGE_CHANGE, function () {
            _this.databind();
        });
        ...
        this.metadataComponent.on("iiifViewerLinkClicked", function (href) {
            ...
            if (rangeId) {
                ...
                if (range) {
                    _this.component.publish(_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].RANGE_CHANGE, range);
                }
            }
        }, false);
    };
...
/* harmony import */ var _modules_uv_dialogues_module_RestrictedDialogue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../modules/uv-dialogues-module/RestrictedDialogue */ "./src/modules/uv-dialogues-module/RestrictedDialogue.ts");
/* harmony import */ var _Shell__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Shell */ "./src/modules/uv-shared-module/Shell.ts");
...
/* harmony import */ var _iiif_vocabulary__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @iiif/vocabulary */ "./node_modules/@iiif/vocabulary/dist-esmodule/index.js");
/* harmony import */ var _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @edsilv/key-codes */ "./node_modules/@edsilv/key-codes/dist-esmodule/index.js");
/* harmony import */ var _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @edsilv/utils */ "./node_modules/@edsilv/utils/dist-esmodule/index.js");
...
var BaseExtension = /** @class */ (function () {
    ...
    BaseExtension.prototype.create = function () {
        ...
        if (_edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Documents"].supportsFullscreen()) {
        ...
        if (!this.data.isReload) {
            var visibilityProp = _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Documents"].getHiddenProp();
            if (visibilityProp) {
                ...
                document.addEventListener(event_1, function () {
                    ...
                    if (!_edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Documents"].isHidden()) {
                        _this.resize();
                    }
                });
            }
            if (_edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Bools"].getBool(this.data.config.options.dropEnabled, true)) {
                this.$element.on("drop", function (e) {
                    e.preventDefault();
                    var dropUrl = e.originalEvent.dataTransfer.getData("URL");
                    var a = _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Urls"].getUrlParts(dropUrl);
                    var manifestUri = _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Urls"].getQuerystringParameterFromString("manifest", a.search);
                    if (!manifestUri) {
                        // look for collection param
                        manifestUri = _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Urls"].getQuerystringParameterFromString("collection", a.search);
                    }
            ...
            this.$element.on("keyup keydown", function (e) {
                ...
                _this.tabbing = e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].Tab;
            });
            this.$element.on("keydown", function (e) {
                var event = null;
                var preventDefault = true;
                if (!e.ctrlKey && !e.altKey && !e.shiftKey) {
                    if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].Enter) {
                        event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].RETURN;
                        preventDefault = false;
                    }
                    if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].Escape)
                        event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].ESCAPE;
                    if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].PageUp)
                        event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].PAGE_UP;
                    if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].PageDown)
                        event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].PAGE_DOWN;
                    if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].End)
                        event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].END;
                    if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].Home)
                        event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].HOME;
                    if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].NumpadPlus ||
                        e.keyCode === 171 ||
                        e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].Equals) {
                        event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].PLUS;
                        preventDefault = false;
                    }
                    if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].NumpadMinus ||
                        e.keyCode === 173 ||
                        e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].Dash) {
                        event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].MINUS;
                        preventDefault = false;
                    }
                    if (that.useArrowKeysToNavigate()) {
                        if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].LeftArrow)
                            event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].LEFT_ARROW;
                        if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].UpArrow)
                            event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].UP_ARROW;
                        if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].RightArrow)
                            event = _BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].RIGHT_ARROW;
                        if (e.keyCode === _edsilv_key_codes__WEBPACK_IMPORTED_MODULE_10__["KeyDown"].DownArrow)
        ...
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].CANVAS_INDEX_CHANGE, function (canvasIndex) {
            _this.data.canvasIndex = canvasIndex;
            _this.lastCanvasIndex = _this.helper.canvasIndex;
            _this.helper.canvasIndex = canvasIndex;
            _this.fire(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].CANVAS_INDEX_CHANGE, _this.data.canvasIndex);
        });
        ...
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].COLLECTION_INDEX_CHANGE, function (collectionIndex) {
            _this.data.collectionIndex = collectionIndex;
            _this.fire(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].COLLECTION_INDEX_CHANGE, _this.data.collectionIndex);
        });
        ...
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].LOAD, function () {
            setTimeout(function () {
                _this.component.publish(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].RESIZE);
                _this.fire(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].LOAD, _this.helper.getCurrentCanvas().id);
        ...
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].LOAD_FAILED, function () {
            ...
            if (!that.lastCanvasIndex == null &&
                ...
                _this.component.publish(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].CANVAS_INDEX_CHANGE, that.lastCanvasIndex);
            }
        });
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].MANIFEST_INDEX_CHANGE, function (manifestIndex) {
            _this.data.manifestIndex = manifestIndex;
            _this.fire(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].MANIFEST_INDEX_CHANGE, _this.data.manifestIndex);
        });
        ...
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].OPEN, function () {
            ...
            var openUri = _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Strings"].format(_this.data.config.options.openTemplate, _this.helper.manifestUri);
            window.open(openUri);
        });
        ...
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].EXTERNAL_RESOURCE_OPENED, function () {
            _this.fire(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].EXTERNAL_RESOURCE_OPENED);
        });
        ...
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].RANGE_CHANGE, function (range) {
            if (range) {
                _this.data.rangeId = range.id;
                _this.helper.rangeId = range.id;
                _this.fire(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].RANGE_CHANGE, _this.data.rangeId);
            }
            else {
                _this.data.rangeId = undefined;
                _this.helper.rangeId = undefined;
                _this.fire(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].RANGE_CHANGE, null);
            }
        });
        ...
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].SETTINGS_CHANGE, function (args) {
            _this.fire(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].SETTINGS_CHANGE, args);
        });
        ...
        this.shell = new _Shell__WEBPACK_IMPORTED_MODULE_7__["Shell"](this.$element);
        this.createModules();
    ...
    BaseExtension.prototype.createModules = function () {
        ...
        this.restrictedDialogue = new _modules_uv_dialogues_module_RestrictedDialogue__WEBPACK_IMPORTED_MODULE_6__["RestrictedDialogue"](this.$restrictedDialogue);
    ...
    BaseExtension.prototype.render = function () {
        if (!this.isCreated ||
            ...
            this.component.publish(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].COLLECTION_INDEX_CHANGE, this.data.collectionIndex);
        }
        if (!this.isCreated ||
            this.data.manifestIndex !== this.helper.manifestIndex) {
            if (this.data.manifestUri !== undefined) {
                this.component.publish(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].MANIFEST_INDEX_CHANGE, this.data.manifestIndex);
            }
        }
        if (!this.isCreated || this.data.canvasIndex !== this.helper.canvasIndex) {
            if (this.data.canvasIndex !== undefined) {
                this.component.publish(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].CANVAS_INDEX_CHANGE, this.data.canvasIndex);
            }
            else {
        ...
        if (!this.isCreated || this.data.rangeId !== this.helper.rangeId) {
            if (this.data.rangeId) {
                ...
                if (range) {
                    this.component.publish(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].RANGE_CHANGE, range);
                }
                else {
    ...
    BaseExtension.prototype._initLocales = function () {
        ...
        if (configuredLocales) {
            ...
            var limitLocales = _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Bools"].getBool(this.data.config.options.limitLocales, false);
            if (!limitLocales) {
            ...
            for (var i = _this.metrics.length - 1; i >= 0; i--) {
                ...
                if (width >= metric.minWidth) {
                    if (_this.metric !== metric.type) {
                        ...
                        _this.component.publish(_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].METRIC_CHANGE);
                    }
                    break;
                }
            }
    ...
    BaseExtension.prototype.getShareUrl = function () {
        ...
        if (!this.data.embedded) {
            ...
            if (_edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Documents"].isInIFrame()) {
    ...
    BaseExtension.prototype.addTimestamp = function (uri) {
        return uri + "?t=" + _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Dates"].getTimeStamp();
    };
    BaseExtension.prototype.getDomain = function () {
        var parts = _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Urls"].getUrlParts(this.helper.manifestUri);
        return parts.host;
    };
    ...
    BaseExtension.prototype.getSettings = function () {
        if (_edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Bools"].getBool(this.data.config.options.saveUserSettings, false)) {
            var settings = _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Storage"].get("uv.settings", _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["StorageType"].LOCAL);
            if (settings) {
    ...
    BaseExtension.prototype.updateSettings = function (settings) {
        if (_edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Bools"].getBool(this.data.config.options.saveUserSettings, false)) {
            var storedSettings = _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Storage"].get("uv.settings", _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["StorageType"].LOCAL);
            if (storedSettings) {
                settings = $.extend(storedSettings.value, settings);
            }
            // store for ten years
            _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Storage"].set("uv.settings", settings, 315360000, _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["StorageType"].LOCAL);
        }
    ...
    BaseExtension.prototype.getExternalResources = function (resources) {
        ...
        indices.forEach(function (index) {
            ...
            if (!canvas.externalResource) {
                r = new _iiif_manifold__WEBPACK_IMPORTED_MODULE_8__["ExternalResource"](canvas, {
    ...
    BaseExtension.prototype._prepareResourceData = function (resource) {
        ...
        return _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Objects"].toPlainObject(resource.data);
    };
    ...
    BaseExtension.prototype.isHeaderPanelEnabled = function () {
        return _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Bools"].getBool(this.data.config.options.headerPanelEnabled, true);
    };
    BaseExtension.prototype.isLeftPanelEnabled = function () {
        if (_edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Bools"].getBool(this.data.config.options.leftPanelEnabled, true)) {
            if (this.helper.hasParentCollection()) {
                ...
                if (!viewingHint ||
                    (viewingHint && viewingHint !== _iiif_vocabulary__WEBPACK_IMPORTED_MODULE_9__["ViewingHint"].CONTINUOUS)) {
                    return true;
                }
            }
        }
    ...
    BaseExtension.prototype.isRightPanelEnabled = function () {
        return _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Bools"].getBool(this.data.config.options.rightPanelEnabled, true);
    };
    BaseExtension.prototype.isFooterPanelEnabled = function () {
        return _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Bools"].getBool(this.data.config.options.footerPanelEnabled, true);
    };
    BaseExtension.prototype.isMobile = function () {
        return $.browser.mobile;
    };
    BaseExtension.prototype.useArrowKeysToNavigate = function () {
        return _edsilv_utils__WEBPACK_IMPORTED_MODULE_11__["Bools"].getBool(this.data.config.options.useArrowKeysToNavigate, true);
    };
...
var FooterPanel = /** @class */ (function (_super) {
    ...
    FooterPanel.prototype.create = function () {
        ...
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].METRIC_CHANGE, function () {
            _this.updateMinimisedButtons();
            _this.updateMoreInfoButton();
        });
        this.component.subscribe(_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].SETTINGS_CHANGE, function () {
...
//# sourceMappingURL=uv-aleph-extension~uv-default-extension~uv-ebook-extension~uv-mediaelement-extension~uv-model-viewer~d066739a.2a4d90ecce232f02f566.js.map