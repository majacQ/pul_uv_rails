...
/***/ "./node_modules/@universalviewer/aleph/dist/esm-es5/tap-click-31591259.js":
/*!********************************************************************************!*\
  !*** ./node_modules/@universalviewer/aleph/dist/esm-es5/tap-click-31591259.js ***!
  \********************************************************************************/
...
var startTapClick = function (config) {
    ...
    var onTouchStart = function (ev) {
        lastTouch = Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_0__["n"])(ev);
        pointerDown(ev);
    };
    ...
    var onMouseDown = function (ev) {
        var t = Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_0__["n"])(ev) - MOUSE_WAIT;
        if (lastTouch < t) {
            pointerDown(ev);
        }
    };
    ...
    var setActivatedElement = function (el, ev) {
        ...
        clearTimeout(activeDefer);
        activeDefer = undefined;
        var _a = Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_0__["p"])(ev), x = _a.x, y = _a.y;
        // deactivate selected
        if (activatableEle) {
...
//# sourceMappingURL=15.d58a68ba7503a6ba2be6.js.map