...
var Events = /** @class */ (function () {
    ...
    Events.PAGE_INDEX_CHANGE = Events.namespace + "pageIndexChange";
...
var Extension = /** @class */ (function (_super) {
    ...
    Extension.prototype.create = function () {
        ...
        this.component.subscribe(_modules_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].THUMB_SELECTED, function (thumb) {
            _this.component.publish(_modules_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].CANVAS_INDEX_CHANGE, thumb.index);
        });
    ...
    Extension.prototype.isHeaderPanelEnabled = function () {
        return (_super.prototype.isHeaderPanelEnabled.call(this) &&
            _edsilv_utils__WEBPACK_IMPORTED_MODULE_12__["Bools"].getBool(this.data.config.options.usePdfJs, true));
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, Promise.all(/*! import() | pdfjs */[__webpack_require__.e(5), __webpack_require__.e(7), __webpack_require__.e("vendors~pdfjs"), __webpack_require__.e("pdfjs")]).then(__webpack_require__.t.bind(null, /*! pdfjs-dist */ "./node_modules/pdfjs-dist/build/pdf.js", 7))];
                    case 4:
                        PDFJS = _b.sent();
                    ...
                    case 5:
                        ...
                        _b.label = 6;
                    case 6:
                        this.component.publish(_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].EXTERNAL_RESOURCE_OPENED);
                        this.component.publish(_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].LOAD);
                        return [2 /*return*/];
                }
            });
        });
    ...
    PDFCenterPanel.prototype._render = function (num) {
        ...
        this._pdfDoc.getPage(num).then(function (page) {
            ...
            _this._renderTask.promise
                .then(function () {
                _this.component.publish(_extensions_uv_pdf_extension_Events__WEBPACK_IMPORTED_MODULE_2__["Events"].PAGE_INDEX_CHANGE, _this._pageIndex);
                _this._pageRendering = false;
...
var PDFHeaderPanel = /** @class */ (function (_super) {
    ...
    PDFHeaderPanel.prototype.create = function () {
        ...
        _super.prototype.create.call(this);
        this.component.subscribe(_extensions_uv_pdf_extension_Events__WEBPACK_IMPORTED_MODULE_1__["Events"].PAGE_INDEX_CHANGE, function (pageIndex) {
            _this._pageIndex = pageIndex;
            _this.render();
        });
...
var ResourcesLeftPanel = /** @class */ (function (_super) {
    ...
    ResourcesLeftPanel.prototype.dataBindThumbsView = function () {
        ...
        if (viewingDirection &&
            (viewingDirection === _iiif_vocabulary__WEBPACK_IMPORTED_MODULE_3__["ViewingDirection"].LEFT_TO_RIGHT ||
                viewingDirection === _iiif_vocabulary__WEBPACK_IMPORTED_MODULE_3__["ViewingDirection"].RIGHT_TO_LEFT)) {
...
//# sourceMappingURL=uv-pdf-extension.17af0bcff6cc350bb6cf.js.map