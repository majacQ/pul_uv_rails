(window["webpackJsonpUV"] = window["webpackJsonpUV"] || []).push([[21],{
...
/***/ "./node_modules/@universalviewer/aleph/dist/esm-es5/ion-nav.entry.js":
/*!***************************************************************************!*\
  !*** ./node_modules/@universalviewer/aleph/dist/esm-es5/ion-nav.entry.js ***!
  \***************************************************************************/
/*! exports provided: ion_nav */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _framework_delegate_8aba239f_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./framework-delegate-8aba239f.js */ "./node_modules/@universalviewer/aleph/dist/esm-es5/framework-delegate-8aba239f.js");
...
/* harmony import */ var _index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index-f1ea188f.js */ "./node_modules/@universalviewer/aleph/dist/esm-es5/index-f1ea188f.js");
...
var ViewController = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, Object(_framework_delegate_8aba239f_js__WEBPACK_IMPORTED_MODULE_2__["a"])(this.delegate, container, component, ['ion-page', 'ion-page-invisible'], this.params)];
                    case 1:
                        _a.element = _b.sent();
                        _b.label = 2;
    ...
    ViewController.prototype._destroy = function () {
        Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(this.state !== VIEW_STATE_DESTROYED, 'view state must be ATTACHED');
...
var Nav = /** @class */ (function () {
    ...
    class_1.prototype.componentWillLoad = function () {
        ...
        if (this.swipeGesture === undefined) {
            ...
            this.swipeGesture = _core_684c60cc_js__WEBPACK_IMPORTED_MODULE_0__["i"].getBoolean('swipeBackEnabled', mode === 'ios');
        }
    ...
    class_1.prototype.componentDidUnload = function () {
        for (var _i = 0, _a = this.views; _i < _a.length; _i++) {
            var view = _a[_i];
            Object(_index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["L"]);
            view._destroy();
        }
        if (this.gesture) {
    ...
    class_1.prototype.prepareTI = function (ti) {
        ...
        if (ti.removeView !== undefined) {
            Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(ti.removeStart !== undefined, 'removeView needs removeStart');
            Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(ti.removeCount !== undefined, 'removeView needs removeCount');
        ...
        Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(insertViews.length > 0, 'length can not be zero');
    ...
    class_1.prototype.postViewInit = function (enteringView, leavingView, ti) {
        Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(leavingView || enteringView, 'Both leavingView and enteringView are null');
        Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(ti.resolve, 'resolve must be valid');
        Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(ti.reject, 'reject must be valid');
        var opts = ti.opts;
        var insertViews = ti.insertViews;
        var removeStart = ti.removeStart;
        ...
        if (removeStart !== undefined && removeCount !== undefined) {
            Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(removeStart >= 0, 'removeStart can not be negative');
            Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(removeCount >= 0, 'removeCount can not be negative');
            destroyQueue = [];
        ...
        Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(finalBalance >= 0, 'final balance can not be negative');
        if (finalBalance === 0) {
        ...
        if (destroyQueue && destroyQueue.length > 0) {
            for (var _a = 0, destroyQueue_1 = destroyQueue; _a < destroyQueue_1.length; _a++) {
                ...
                Object(_index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["a"]);
                Object(_index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["b"]);
                Object(_index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["L"]);
            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        animationOpts = Object.assign({ mode: mode, showGoBack: this.canGoBackSync(enteringView), baseEl: this.el, animationBuilder: this.animation || opts.animationBuilder || _core_684c60cc_js__WEBPACK_IMPORTED_MODULE_0__["i"].get('navAnimation'), progressCallback: progressCallback, animated: this.animated && _core_684c60cc_js__WEBPACK_IMPORTED_MODULE_0__["i"].getBoolean('animated', true), enteringEl: enteringEl,
                            leavingEl: leavingEl }, opts);
                        return [4 /*yield*/, Object(_index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["t"])(animationOpts)];
                    case 1:
    ...
    class_1.prototype.insertViewAt = function (view, index) {
        ...
        if (existingIndex > -1) {
            ...
            Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(view.nav === this, 'view is not part of the nav');
            views.splice(index, 0, views.splice(existingIndex, 1)[0]);
        }
        else {
            Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(!view.nav, 'nav is used');
    ...
    class_1.prototype.removeView = function (view) {
        Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(view.state === VIEW_STATE_ATTACHED || view.state === VIEW_STATE_DESTROYED, 'view state should be loaded or destroyed');
        var views = this.views;
        var index = views.indexOf(view);
        Object(_helpers_1644482e_js__WEBPACK_IMPORTED_MODULE_1__["b"])(index > -1, 'view must be part of the stack');
        if (index >= 0) {
    ...
    class_1.prototype.cleanup = function (activeView) {
        ...
        for (var i = views.length - 1; i >= 0; i--) {
            ...
            if (i > activeViewIndex) {
                ...
                // let's unload it
                Object(_index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["l"])(element, _index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["L"]);
                this.destroyView(view);
            }
            else if (i < activeViewIndex) {
                // this view comes before the active view
                // and it is not a portal then ensure it is hidden
                Object(_index_f1ea188f_js__WEBPACK_IMPORTED_MODULE_4__["s"])(element, true);
            }
        }
    };
    ...
    class_1.prototype.onEnd = function (shouldComplete, stepValue, dur) {
        ...
        if (this.sbAni) {
            ...
            if (!shouldComplete) {
                ...
                newStepValue += Object(_cubic_bezier_287346e4_js__WEBPACK_IMPORTED_MODULE_3__["g"])(new _cubic_bezier_287346e4_js__WEBPACK_IMPORTED_MODULE_3__["P"](0, 0), new _cubic_bezier_287346e4_js__WEBPACK_IMPORTED_MODULE_3__["P"](1, 0), new _cubic_bezier_287346e4_js__WEBPACK_IMPORTED_MODULE_3__["P"](0.68, 0.28), new _cubic_bezier_287346e4_js__WEBPACK_IMPORTED_MODULE_3__["P"](1, 1), stepValue);
            }
            else {
                newStepValue += Object(_cubic_bezier_287346e4_js__WEBPACK_IMPORTED_MODULE_3__["g"])(new _cubic_bezier_287346e4_js__WEBPACK_IMPORTED_MODULE_3__["P"](0, 0), new _cubic_bezier_287346e4_js__WEBPACK_IMPORTED_MODULE_3__["P"](0.32, 0.72), new _cubic_bezier_287346e4_js__WEBPACK_IMPORTED_MODULE_3__["P"](0, 1), new _cubic_bezier_287346e4_js__WEBPACK_IMPORTED_MODULE_3__["P"](1, 1), stepValue);
            }
...
//# sourceMappingURL=21.659cd3393321cc8991d6.js.map