...
var Events = /** @class */ (function () {
    ...
    Events.MODE_CHANGE = Events.namespace + "modeChange";
    ...
    Events.OPENSEADRAGON_ROTATION = Events.namespace + "rotationChange";
    ...
    Events.XYWH_CHANGE = Events.namespace + "xywhChange";
...
var ContentLeftPanel = /** @class */ (function (_super) {
    ...
    ContentLeftPanel.prototype.create = function () {
        ...
        this.component.subscribe(_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_1__["BaseEvents"].METRIC_CHANGE, function () {
        ...
        this.component.subscribe(_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_1__["BaseEvents"].RANGE_CHANGE, function () {
            if (_this.isFullyExpanded) {
                _this.collapseFull();
            }
            _this.selectCurrentTreeNode();
...
var ThumbsView = /** @class */ (function (_super) {
    ...
    ThumbsView.prototype.create = function () {
        ...
        this.component.subscribe(_extensions_uv_openseadragon_extension_Events__WEBPACK_IMPORTED_MODULE_1__["Events"].MODE_CHANGE, function () {
            _this.setLabel();
        });
...
//# sourceMappingURL=uv-model-viewer-extension~uv-openseadragon-extension.b1ff0c7bcae084747aea.js.map