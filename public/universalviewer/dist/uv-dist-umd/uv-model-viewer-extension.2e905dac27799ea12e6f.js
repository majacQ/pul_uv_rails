...
/***/ "./src/extensions/uv-model-viewer-extension/Events.ts":
/*!************************************************************!*\
  !*** ./src/extensions/uv-model-viewer-extension/Events.ts ***!
  \************************************************************/
...
var Events = /** @class */ (function () {
    ...
    Events.namespace = "modelViewerExtension.";
    Events.CAMERA_CHANGE = Events.namespace + "cameraChange";
    return Events;
}());
...
/* harmony import */ var _Events__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Events */ "./src/extensions/uv-model-viewer-extension/Events.ts");
/* harmony import */ var _Orbit__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Orbit */ "./src/extensions/uv-model-viewer-extension/Orbit.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var Extension = /** @class */ (function (_super) {
    ...
    Extension.prototype.create = function () {
        ...
        this.component.subscribe(_modules_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].THUMB_SELECTED, function (canvasIndex) {
            _this.component.publish(_modules_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].CANVAS_INDEX_CHANGE, canvasIndex);
        });
        this.component.subscribe(_Events__WEBPACK_IMPORTED_MODULE_16__["Events"].CAMERA_CHANGE, function (orbit) {
            var canvas = _this.helper.getCurrentCanvas();
            if (canvas) {
                _this.data.target = canvas.id + "#" + ("orbit=" + orbit.toString());
                _this.fire(_modules_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].TARGET_CHANGE, _this.data.target);
            }
        });
    };
    ...
    Extension.prototype.checkForTarget = function () {
        if (this.data.target) {
            ...
            if (index !== null && this.helper.canvasIndex !== index) {
                this.component.publish(_modules_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].CANVAS_INDEX_CHANGE, index);
            }
            // trigger SET_TARGET which sets the camera-orbit attribute in ModelViewerCenterPanel
            var selector = components[1];
            this.component.publish(_modules_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_0__["BaseEvents"].SET_TARGET, _Orbit__WEBPACK_IMPORTED_MODULE_17__["Orbit"].fromString(selector));
        }
    };
...
/***/ "./src/extensions/uv-model-viewer-extension/Orbit.ts":
/*!***********************************************************!*\
  !*** ./src/extensions/uv-model-viewer-extension/Orbit.ts ***!
  \***********************************************************/
...
/* harmony import */ var _extensions_uv_model_viewer_extension_Events__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../extensions/uv-model-viewer-extension/Events */ "./src/extensions/uv-model-viewer-extension/Events.ts");
/* harmony import */ var _extensions_uv_model_viewer_extension_Orbit__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../extensions/uv-model-viewer-extension/Orbit */ "./src/extensions/uv-model-viewer-extension/Orbit.ts");
...
var ModelViewerCenterPanel = /** @class */ (function (_super) {
    ...
    ModelViewerCenterPanel.prototype.create = function () {
        ...
        this.$modelViewer[0].addEventListener("model-visibility", function () {
            ...
            _this.$spinner.hide();
            _this.component.publish(_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].LOAD);
            _this.component.publish(_extensions_uv_model_viewer_extension_Events__WEBPACK_IMPORTED_MODULE_5__["Events"].CAMERA_CHANGE, _this.getCameraOrbit());
        });
        this.$modelViewer[0].addEventListener("camera-change", Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["debounce"])(function (obj) {
            if (_this.isLoaded) {
    ...
    ModelViewerCenterPanel.prototype.whenLoaded = function (cb) {
        var _this = this;
        _edsilv_utils__WEBPACK_IMPORTED_MODULE_7__["Async"].waitFor(function () {
    ...
    ModelViewerCenterPanel.prototype.getCameraOrbit = function () {
        if (this.$modelViewer) {
            ...
            var tpr = new _extensions_uv_model_viewer_extension_Orbit__WEBPACK_IMPORTED_MODULE_6__["Orbit"](orbit.theta, orbit.phi, orbit.radius);
            return tpr;
        }
        return null;
    };
...
//# sourceMappingURL=uv-model-viewer-extension.2e905dac27799ea12e6f.js.map